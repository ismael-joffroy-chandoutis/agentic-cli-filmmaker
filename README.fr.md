...
| [Montage piloté par agent : le classement, phase par phase](essays/2026-09-14-agent-editing-ranking-by-phase.fr.md) ([EN](essays/2026-09-14-agent-editing-ranking-by-phase.md)) | Les tableaux derrière la position : quel outil pour quelle phase, sur quelle machine, par quel canal, et ce qui est mort ou vivant. Onze canevas et deux éditeurs agent-first passés sous un même protocole ; Palmier réussit l'aller-retour FCPXML, SpliceKit remarche sur Final Cut 12.3, Deforum reste un instrument. |
