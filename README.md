...
| [Agent-Driven Editing: the Ranking, Phase by Phase](essays/2026-09-14-agent-editing-ranking-by-phase.md) ([FR](essays/2026-09-14-agent-editing-ranking-by-phase.fr.md)) | The tables behind the position: which tool for which phase, on which machine, through which channel, and what is dead or alive. Eleven canvases and two agent-first editors run under one protocol; Palmier passed the FCPXML round trip, SpliceKit works again on Final Cut 12.3, Deforum stays an instrument. |
